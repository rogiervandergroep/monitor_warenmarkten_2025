...
v10_watmistu_bez <- v10_watmistu |>
  map(\(x) my_filter(x))

write.xlsx(v10_watmistu_bez, "05 output tabellen/tabel_v10_watmistu.xlsx")
write_rds(v10_watmistu_bez, "03 intermediate/tabel_v10_watmistu.rds")
